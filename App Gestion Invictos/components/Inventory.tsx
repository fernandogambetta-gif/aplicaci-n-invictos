              ...
              <div className="p-5 border-b border-slate-200 bg-amber-50">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mt-1">
                      El ingreso no se guardará hasta validar el PIN de un administrador.
                    </p>
                  </div>
                </div>
              </div>
                ...
                {!formData.id ? (<div className="border border-indigo-200 rounded-xl overflow-hidden">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                          ...
                          <div className="text-xs text-slate-500 mb-2">
                            Seleccioná uno o varios talles disponibles.
                          </div>
                    ...
                    if (e.key === 'Enter') {
                        ...
                        <div>
                          ...
                          <div className="text-xs text-slate-500 mb-2">
                            Seleccioná uno o varios colores disponibles.
                          </div>
